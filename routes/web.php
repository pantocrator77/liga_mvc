...
Route::get('teams/{id}','App\Http\Controllers\TeamController@select_team2')->name('select_team2');
Route::get('teams', 'App\Http\Controllers\TeamController@teams')->name('select_team2');
