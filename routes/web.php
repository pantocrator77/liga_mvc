...
Route::get('teams/{id}','App\Http\Controllers\TeamController@select_teams2')->name('select_teams');

//Route::get('teams', 'App\Http\Controllers\ClubController@select_teams')->name('select_teams');
